<x-layout.admin title="Add Institute">
    <div>
        <div class="flex items-center justify-between mb-5">
            <h5 class="text-lg font-semibold dark:text-white-light">Add Institute</h5>
            ...
            <form action="{{ route('admin.institutes.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2 mb-6">
                    ...
                    <div>
                        ...
                        <input id="tagline" name="tagline" type="text" class="form-input" value="{{ old('tagline') }}" placeholder="Short catchy tagline" />
                    </div>
                    <div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="about" name="about" class="form-textarea" rows="4">{{ old('about') }}</textarea>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2 mb-6">
                    <div>
                        ...
                        <input id="area" name="area" type="text" class="form-input" value="{{ old('area') }}" />
                    </div>
                    <div>
                        <label for="pincode">Pincode</label>
                        <input id="pincode" name="pincode" type="text" class="form-input" value="{{ old('pincode') }}" maxlength="10" />
                    </div>
                    <div class="md:col-span-2">
                        <label for="full_address">Full Address</label>
                        <textarea id="full_address" name="full_address" class="form-textarea" rows="2">{{ old('full_address') }}</textarea>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2 mb-6">
                    ...
                    <div>
                        ...
                        <input id="whatsapp" name="whatsapp" type="text" class="form-input" value="{{ old('whatsapp') }}" />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input id="website" name="website" type="url" class="form-input" value="{{ old('website') }}" placeholder="https://" />
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2 mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-400 mt-1">Max 4MB. Recommended 1200x400px</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2 mb-6">
                    <div>
                        ...
                        <textarea id="certifications" name="certifications" class="form-textarea" rows="4" placeholder="One certification per line&#10;e.g. ISO 9001:2015&#10;NSDC Certified">{{ old('certifications') }}</textarea>
                        <p class="text-xs text-gray-400 mt-1">Enter one per line</p>
                    </div>
                    <div>
                        <label for="facilities">Facilities</label>
                        <textarea id="facilities" name="facilities" class="form-textarea" rows="4" placeholder="One facility per line&#10;e.g. AC Classroom&#10;Free WiFi&#10;Library">{{ old('facilities') }}</textarea>
                        <p class="text-xs text-gray-400 mt-1">Enter one per line</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-3 mb-6">
                    ...
                    <div class="flex items-center gap-3 pt-6">
                        <label class="relative inline-flex cursor-pointer">
                            <input type="checkbox" name="is_verified" value="1" class="sr-only peer" {{ old('is_verified') ? 'checked' : '' }} />
